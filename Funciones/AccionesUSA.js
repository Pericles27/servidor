    ...
    if (!cachedData) {
        try {
            ...
            let config = {
                ...
                url: `https://api.invertironline.com/api/Cotizaciones/acciones/SP500/estados_unidos?panelCotizacion.instrumento=acciones&panelCotizacion.panel=SP500&panelCotizacion.pais=estados_Unidos&api_key=${Clave}`,
                headers: { 
...
export default CotizacionesUSA;

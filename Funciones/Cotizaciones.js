    ...
    if (!cachedData) {
        try {
            ...
            let config = {
                ...
                url: `https://api.invertironline.com/api/Cotizaciones/bonos/todos/argentina?panelCotizacion.instrumento=bonos&panelCotizacion.panel=todos&panelCotizacion.pais=argentina&api_key=${Clave}`,
                headers: { 

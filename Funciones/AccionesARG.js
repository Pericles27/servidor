    ...
    if (!cachedData) {
        try {
            ...
            let config = {
                ...
                url: `https://api.invertironline.com/api/Cotizaciones/acciones/Merval/estados_unidos?panelCotizacion.instrumento=acciones&panelCotizacion.panel=Merval&panelCotizacion.pais=argentina&api_key=${Clave}`,
                headers: { 
